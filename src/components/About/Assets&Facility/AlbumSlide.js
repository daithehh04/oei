...
export default function AlbumSlide() {
    ...
    return (
        <div className="relative slide-certified border-t border-[#fff]">
            <div className="flex flex-col gap-y-[1.5vw] gap-x-[calc(1.5*100vw/100)] btn-action">
                <button
                    className={`${
                        indexSlider === 0
            ...
            >
                {arrTeams.map((news, index) => (
                    <SwiperSlide
                        key={index}
                        className="!h-fit relative slide-item-certified w-[34%]"
                    >
                        {({ isActive }) => (
                            <Link href="/" className="w-full">
                                <div className="w-full h-[calc(34.8125*100vw/100)] img-certified">
                                    <Image
                                        width={344}
                                        height={426}

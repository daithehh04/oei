...
import SlideQuality from "./SlideQuality";
...
export default function Quality({ data }) {
    ...
    // }, []);
    return (
        <div className="relative z-50 quality bg-member">
            <div className="content">
                ...
                <div className="container-quality pt-[9.3125vw] flex items-start lg:flex-col">
                    <div className="left text-60pc text-[#fff] font-[800] leading-[1.33] tracking-tighter w-[40.375vw] lg:w-[80%] lg:text-[4.8vw] md:text-[8vw] md:pb-0 lg:pb-[5vw]">
                        {data?.title}
                    </div>
                    <div className="right list-quality w-[44.8125vw] ml-auto relative lg:w-full overflow-y-scroll max-h-[90vh] pb-[4vw] z-10 md:hidden">
                    ...
                    <div className="hidden w-full md:block">
                        <SlideQuality dataSlide={data?.listItem} />
                    </div>
                </div>
                <Image
                    src={img}
                    ...
                    height={500}
                    alt="img"
                    className="absolute bottom-0 object-cover w-full h-full -z-1 md:hidden"
                />
            </div>
        </div>
    );

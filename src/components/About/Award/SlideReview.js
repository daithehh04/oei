    ...
    return (
        <div className="relative slide-review ">
            <Swiper
                ...
                className="w-full flex flex-col items-end relative swiper-lastnews "
            >
                        ...
                        {({ isActive }) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="item-review bg-white transition-all duration-500 flex flex-col justify-center">
                                        <Image
                                            width={100}
                                            height={100}
                                            src={img2}
